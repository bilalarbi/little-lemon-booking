    ...
    <Container {...props}>
      ...
      <Cards>
        ...
        <CustomersSayCard
          ...
          customerName="Bruno"
          testimonial="I have been to many restaurants, which was beautiful. It was an amazing dining experience.The food was wonderful and the atmosphere was very cozy. "
        />
        <CustomersSayCard
          rating={5}
